...
class Subtraction2(tf.keras.Model):
    ...
    def call(self, input1, input2):
        ...
        unfold_i = san.tensorflow_unfold(input1, 1, self.dilation, 0, self.stride)
        unfold_j = san.tensorflow_unfold(input2, self.kernel_size, self.dilation, padding, self.stride)
